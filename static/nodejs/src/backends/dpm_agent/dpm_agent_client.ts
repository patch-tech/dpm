...
const projectionOperatorMap = {
  ...
  dayOfWeek: DpmAgentQuery.DerivedExpression.ProjectionOperator.DAY_OF_WEEK,
  week: DpmAgentQuery.DerivedExpression.ProjectionOperator.WEEK,
  weekDate: DpmAgentQuery.DerivedExpression.ProjectionOperator.DATE_OF_WEEK,
  date: DpmAgentQuery.DerivedExpression.ProjectionOperator.DATE,
  time: DpmAgentQuery.DerivedExpression.ProjectionOperator.TIME,
