    ...
    public class TestQueryFormulation
    {
        ...
        public void TestQuery()
        {
            ...
            var wantQueryStr =
                ...
                "], \"filter\": { \"op\": \"OR\", \"arguments\": [ { \"condition\": { \"op\": " +
                "\"OR\", \"arguments\": [ { \"condition\": { \"op\": \"LIKE\", \"arguments\": [ " +
                "{ \"field\": { \"fieldName\": \"name\" } }, { \"literal\": { \"string\": " +
                "\"%ammy%\" } } ] } }, { \"condition\": { \"op\": \"GT\", \"arguments\": [ { " +
                "\"field\": { \"fieldName\": \"price\" } }, { \"literal\": { \"f32\": 10 } } ] } " +
                "} ] } }, { \"condition\": { \"op\": \"HAS_ANY\", \"arguments\": [ { \"field\": " +
                "{ \"fieldName\": \"tags\" } }, { \"literal\": { \"list\": { \"values\": [ { " +
                "\"string\": \"foo\" }, { \"string\": \"bar\" } ] } } } ] } } ] }, \"groupBy\": " +
